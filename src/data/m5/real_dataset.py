...
class M5Dataset(Dataset):
    ...
    def __init__(self,
        ...
        user_sizes = vitals.groupby(['id']).size()
...
class M5DatasetCollection(RealDatasetCollection):
    """
    ...
    def __init__(self,
        ...
        Args:
            ...
            autoregressive:
        """
        super(M5DatasetCollection, self).__init__()
        self.seed = seed
        treatments, outcomes, vitals, static_features, outcomes_unscaled, scaling_params = \
            load_m5_data_processed(ROOT_PATH + "\\" + path, min_seq_length=min_seq_length, max_seq_length=max_seq_length,
        ...
        self.train_f = M5Dataset(treatments_train, outcomes_train, vitals_train, static_features_train,
                                         outcomes_unscaled_train, scaling_params, 'train')
        if split['val'] > 0.0:
            self.val_f = M5Dataset(treatments_val, outcomes_val, vitals_val, static_features_val, outcomes_unscaled_val,
                                           scaling_params, 'val')
        self.test_f = M5Dataset(treatments_test, outcomes_test, vitals_test, static_features_test, outcomes_unscaled_test,
                                        scaling_params, 'test')
